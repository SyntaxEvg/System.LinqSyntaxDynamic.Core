...
internal class ConstantExpressionWrapper : IConstantExpressionWrapper
{
    ...
    public bool TryUnwrapAsValue<TValue>(MemberExpression? expression, out TValue? value)
    {
    ...
    public bool TryUnwrapAsConstantExpression<TValue>(MemberExpression? expression, out ConstantExpression? value)
    {
