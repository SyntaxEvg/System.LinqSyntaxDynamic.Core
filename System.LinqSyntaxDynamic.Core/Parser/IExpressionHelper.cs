...
internal interface IExpressionHelper
{
    ...
    bool TryUnwrapAsValue<TValue>(Expression? expression,  out TValue? value);

    bool TryUnwrapAsConstantExpression<TValue>(Expression? expression, out ConstantExpression? value);

    bool TryUnwrapAsConstantExpression(Expression? expression, out ConstantExpression? value);
