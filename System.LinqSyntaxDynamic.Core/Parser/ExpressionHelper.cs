...
internal class ExpressionHelper : IExpressionHelper
{
    ...
    public bool TryUnwrapAsValue<TValue>(Expression? expression,  out TValue? value)
    {
    ...
    public bool TryUnwrapAsConstantExpression<TValue>(Expression? expression,  out ConstantExpression? value)
    {
    ...
    public bool TryUnwrapAsConstantExpression(Expression? expression, out ConstantExpression? value)
    {
